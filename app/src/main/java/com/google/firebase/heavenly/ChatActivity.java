...
import com.google.firebase.heavenly.databinding.ActivityChatBinding;
import com.google.firebase.heavenly.message.Message;
import com.google.firebase.heavenly.message.MessagesAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.sendMessageBtn.setOnClickListener(v ->{
            ...
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd.MM.yyyy HH:mm"); // for date
            String date = simpleDateFormat.format(new Date());

            binding.messageEt.setText(""); // clearing text
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for(DataSnapshot messageSnapshot : snapshot.getChildren()){
                            ...
                            String ownerId = messageSnapshot.child("ownerId")
                                    .getValue().toString();
                            String text = messageSnapshot.child("text").getValue()
                                    .toString();
                            String date = messageSnapshot.child("date").getValue()
                                    .toString();
