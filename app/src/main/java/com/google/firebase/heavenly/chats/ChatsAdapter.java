package com.google.firebase.heavenly.chats;
...
import com.google.firebase.heavenly.ChatActivity;
...
public class ChatsAdapter extends RecyclerView.Adapter<ChatViewHolder>{
    ...
    public ChatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.person_chat_item_rv, parent, false);
